...
export const metadata: Metadata = {
  title: "Iptv Streamer IPTV Instruktioner | Monster TV",
  description: "Installera Iptv Streamer pa Nvidia Shield. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Iptv Streamer", "IPTV", "Monster TV", "installera", "guide", "Nvidia Shield"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/nvidia-shield/iptv-streamer/" },
  openGraph: {
    title: "Iptv Streamer IPTV Instruktioner | Monster TV",
    description: "Installera Iptv Streamer pa Nvidia Shield.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/nvidia-shield/iptv-streamer/",
    siteName: "Monster TV",
    images: [{ url: "https://monstertv.tv/images/allsvenskan-2026.jpg", width: 1200, height: 630, alt: "Monster TV - Iptv Streamer" }]
  },
  twitter: {
