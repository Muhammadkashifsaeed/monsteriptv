...
export const metadata: Metadata = {
  ...
  description: "Installera Smart Stb pa Nvidia Shield. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Smart Stb", "IPTV", "Monster TV", "installera", "guide", "Nvidia Shield"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/nvidia-shield/smart-stb/" },
  openGraph: {
    title: "Smart Stb IPTV Instruktioner | Monster TV",
    description: "Installera Smart Stb pa Nvidia Shield.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/nvidia-shield/smart-stb/",
    siteName: "Monster TV",
