...
export const metadata: Metadata = {
  ...
  description: "Installera Iptvx pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Iptvx", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/iptvx/" },
  openGraph: {
    title: "Iptvx IPTV Instruktioner | Monster TV",
    description: "Installera Iptvx pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/iptvx/",
    siteName: "Monster TV",
