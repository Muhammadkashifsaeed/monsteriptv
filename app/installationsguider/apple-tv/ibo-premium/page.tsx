...
export const metadata: Metadata = {
  ...
  description: "Installera Ibo Premium pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Ibo Premium", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/ibo-premium/" },
  openGraph: {
    title: "Ibo Premium IPTV Instruktioner | Monster TV",
    description: "Installera Ibo Premium pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/ibo-premium/",
    siteName: "Monster TV",
