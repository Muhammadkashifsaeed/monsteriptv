...
export const metadata: Metadata = {
  ...
  description: "Installera Iplaytv pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Iplaytv", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/iplaytv/" },
  openGraph: {
    title: "Iplaytv IPTV Instruktioner | Monster TV",
    description: "Installera Iplaytv pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/iplaytv/",
    siteName: "Monster TV",
