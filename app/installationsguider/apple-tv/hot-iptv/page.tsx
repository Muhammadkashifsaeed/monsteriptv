...
export const metadata: Metadata = {
  ...
  description: "Installera Hot Iptv pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Hot Iptv", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/hot-iptv/" },
  openGraph: {
    title: "Hot Iptv IPTV Instruktioner | Monster TV",
    description: "Installera Hot Iptv pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/hot-iptv/",
    siteName: "Monster TV",
