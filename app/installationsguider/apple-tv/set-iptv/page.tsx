...
export const metadata: Metadata = {
  ...
  description: "Installera Set Iptv pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Set Iptv", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/set-iptv/" },
  openGraph: {
    title: "Set Iptv IPTV Instruktioner | Monster TV",
    description: "Installera Set Iptv pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/set-iptv/",
    siteName: "Monster TV",
