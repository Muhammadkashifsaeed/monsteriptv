...
export const metadata: Metadata = {
  ...
  description: "Installera Mega Iptv pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Mega Iptv", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/mega-iptv/" },
  openGraph: {
    title: "Mega Iptv IPTV Instruktioner | Monster TV",
    description: "Installera Mega Iptv pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/mega-iptv/",
    siteName: "Monster TV",
