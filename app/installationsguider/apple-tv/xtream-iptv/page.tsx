...
export const metadata: Metadata = {
  ...
  description: "Installera Xtream Iptv pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Xtream Iptv", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/xtream-iptv/" },
  openGraph: {
    title: "Xtream Iptv IPTV Instruktioner | Monster TV",
    description: "Installera Xtream Iptv pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/xtream-iptv/",
    siteName: "Monster TV",
