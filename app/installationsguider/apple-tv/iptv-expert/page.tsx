...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Expert pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Iptv Expert", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/iptv-expert/" },
  openGraph: {
    title: "Iptv Expert IPTV Instruktioner | Monster TV",
    description: "Installera Iptv Expert pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/iptv-expert/",
    siteName: "Monster TV",
