...
export const metadata: Metadata = {
  ...
  description: "Installera Tivimate pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Tivimate", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/tivimate/" },
  openGraph: {
    title: "Tivimate IPTV Instruktioner | Monster TV",
    description: "Installera Tivimate pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/tivimate/",
    siteName: "Monster TV",
