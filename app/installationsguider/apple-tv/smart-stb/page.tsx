...
export const metadata: Metadata = {
  ...
  description: "Installera Smart Stb pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Smart Stb", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/smart-stb/" },
  openGraph: {
    title: "Smart Stb IPTV Instruktioner | Monster TV",
    description: "Installera Smart Stb pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/smart-stb/",
    siteName: "Monster TV",
