...
export const metadata: Metadata = {
  ...
  description: "Installera Perfect Iptv pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Perfect Iptv", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/perfect-iptv/" },
  openGraph: {
    title: "Perfect Iptv IPTV Instruktioner | Monster TV",
    description: "Installera Perfect Iptv pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/perfect-iptv/",
    siteName: "Monster TV",
