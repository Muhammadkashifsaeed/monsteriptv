...
export const metadata: Metadata = {
  ...
  description: "Installera Ibo Player pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Ibo Player", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/ibo-player/" },
  openGraph: {
    title: "Ibo Player IPTV Instruktioner | Monster TV",
    description: "Installera Ibo Player pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/ibo-player/",
    siteName: "Monster TV",
