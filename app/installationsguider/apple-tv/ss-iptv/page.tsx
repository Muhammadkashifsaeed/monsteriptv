...
export const metadata: Metadata = {
  ...
  description: "Installera Ss Iptv pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Ss Iptv", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/ss-iptv/" },
  openGraph: {
    title: "Ss Iptv IPTV Instruktioner | Monster TV",
    description: "Installera Ss Iptv pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/ss-iptv/",
    siteName: "Monster TV",
