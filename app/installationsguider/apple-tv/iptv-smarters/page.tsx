...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Smarters pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Iptv Smarters", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/iptv-smarters/" },
  openGraph: {
    title: "Iptv Smarters IPTV Instruktioner | Monster TV",
    description: "Installera Iptv Smarters pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/iptv-smarters/",
    siteName: "Monster TV",
