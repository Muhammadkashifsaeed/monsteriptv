...
export const metadata: Metadata = {
  ...
  description: "Installera Net Iptv pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Net Iptv", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/net-iptv/" },
  openGraph: {
    title: "Net Iptv IPTV Instruktioner | Monster TV",
    description: "Installera Net Iptv pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/net-iptv/",
    siteName: "Monster TV",
