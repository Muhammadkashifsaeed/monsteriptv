...
export const metadata: Metadata = {
  ...
  description: "Installera Duplex Play pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Duplex Play", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/duplex-play/" },
  openGraph: {
    title: "Duplex Play IPTV Instruktioner | Monster TV",
    description: "Installera Duplex Play pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/duplex-play/",
    siteName: "Monster TV",
