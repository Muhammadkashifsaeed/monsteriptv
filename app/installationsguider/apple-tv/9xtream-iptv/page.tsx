...
export const metadata: Metadata = {
  ...
  description: "Installera 9xtream Iptv pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["9xtream Iptv", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/9xtream-iptv/" },
  openGraph: {
    title: "9xtream Iptv IPTV Instruktioner | Monster TV",
    description: "Installera 9xtream Iptv pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/9xtream-iptv/",
    siteName: "Monster TV",
      ...
      <section className="relative w-full py-12 md:py-16 flex items-center justify-center bg-[#0a0a0a]">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-5 tracking-tight drop-shadow-lg">
            9Xtream IPTV IPTV Instruktioner
          </h1>
          ...
          <nav className="flex items-center gap-2 text-white/80 text-base mb-8">
            ...
            <span>/</span>
            <span className="text-gray-300">9Xtream IPTV</span>
          </nav>
          
          <div className="text-gray-200 text-base md:text-lg leading-relaxed max-w-3xl">
            <p>
              9Xtream IPTV IPTV Instruktioner – Här ser du hur man kommer igång med 9Xtream IPTV för att se på IPTV. Klicka på knappen nedan för att läsa mer om hur du installerar och konfigurerar 9Xtream IPTV på din enhet.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl bg-black px-6 md:px-12 py-16 border border-gray-900 shadow-2xl">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 tracking-tight">
                Så här installerar du 9Xtream IPTV
              </h2>
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                Följ våra steg-för-steg instruktioner för att komma igång med 9Xtream IPTV. Med våra guider blir installationen enkel och smidig.
              </p>
