...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Pro pa Apple TV. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Iptv Pro", "IPTV", "Monster TV", "installera", "guide", "Apple TV"],
  alternates: { canonical: "https://monstertv.tv/installationsguider/apple-tv/iptv-pro/" },
  openGraph: {
    title: "Iptv Pro IPTV Instruktioner | Monster TV",
    description: "Installera Iptv Pro pa Apple TV.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/installationsguider/apple-tv/iptv-pro/",
    siteName: "Monster TV",
