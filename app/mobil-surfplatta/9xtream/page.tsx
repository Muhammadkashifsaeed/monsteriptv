...
export const metadata: Metadata = {
  ...
  description: "Installera 9xtream på Mobil Surfplatta. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["9xtream", "IPTV", "mobil-surfplatta", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/mobil-surfplatta/9xtream/" },
  openGraph: {
    title: "9xtream IPTV Instruktioner | Monster TV",
    description: "9xtream på Mobil Surfplatta. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/mobil-surfplatta/9xtream/",
    siteName: "Monster TV",
