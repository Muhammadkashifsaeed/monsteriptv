...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Smarters på Mobil Surfplatta. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-smarters", "IPTV", "mobil-surfplatta", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/mobil-surfplatta/iptv-smarters/" },
  openGraph: {
    title: "Iptv Smarters IPTV Instruktioner | Monster TV",
    description: "Iptv Smarters på Mobil Surfplatta. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/mobil-surfplatta/iptv-smarters/",
    siteName: "Monster TV",
