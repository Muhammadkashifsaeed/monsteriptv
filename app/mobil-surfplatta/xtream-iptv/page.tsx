...
export const metadata: Metadata = {
  ...
  description: "Installera Xtream Iptv på Mobil Surfplatta. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["xtream-iptv", "IPTV", "mobil-surfplatta", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/mobil-surfplatta/xtream-iptv/" },
  openGraph: {
    title: "Xtream Iptv IPTV Instruktioner | Monster TV",
    description: "Xtream Iptv på Mobil Surfplatta. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/mobil-surfplatta/xtream-iptv/",
    siteName: "Monster TV",
