...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Pro på Mobil Surfplatta. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-pro", "IPTV", "mobil-surfplatta", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/mobil-surfplatta/iptv-pro/" },
  openGraph: {
    title: "Iptv Pro IPTV Instruktioner | Monster TV",
    description: "Iptv Pro på Mobil Surfplatta. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/mobil-surfplatta/iptv-pro/",
    siteName: "Monster TV",
