...
export const metadata: Metadata = {
  title: "Iptv X IPTV Instruktioner | Monster TV",
  description: "Installera Iptv X på Mobil Surfplatta. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-x", "IPTV", "mobil-surfplatta", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/mobil-surfplatta/iptv-x/" },
  openGraph: {
    title: "Iptv X IPTV Instruktioner | Monster TV",
    description: "Iptv X på Mobil Surfplatta. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/mobil-surfplatta/iptv-x/",
    siteName: "Monster TV",
    images: [{ url: "https://monstertv.tv/images/allsvenskan-2026.jpg", width: 1200, height: 630, alt: "Monster TV - Iptv X" }],
  },
  twitter: {
      ...
      <section className="relative w-full py-12 md:py-16 flex items-center justify-center bg-[#0a0a0a]">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-white/80 text-base mb-8">
            ...
            <span>/</span>
            <span className="text-gray-300">IPTV X</span>
          </nav>
          
          <div className="text-gray-200 text-base md:text-lg leading-relaxed max-w-3xl">
            <p>
              IPTV X IPTV Instruktioner – Här ser du hur man kommer igång med IPTV X för att se på IPTV. Klicka på knappen nedan för att läsa mer om hur du installerar och konfigurerar IPTV X på din enhet.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl bg-black px-6 md:px-12 py-16 border border-gray-900 shadow-2xl">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 tracking-tight">
                Så här installerar du IPTV X
              </h2>
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                Följ våra steg-för-steg instruktioner för att komma igång med IPTV X. Med våra guider blir installationen enkel och smidig.
              </p>
