...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Streamer på Formuler Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-streamer", "IPTV", "formuler-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/formuler-box/iptv-streamer/" },
  openGraph: {
    title: "Iptv Streamer IPTV Instruktioner | Monster TV",
    description: "Iptv Streamer på Formuler Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/formuler-box/iptv-streamer/",
    siteName: "Monster TV",
