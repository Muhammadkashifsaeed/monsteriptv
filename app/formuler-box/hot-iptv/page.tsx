...
export const metadata: Metadata = {
  ...
  description: "Installera Hot Iptv på Formuler Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["hot-iptv", "IPTV", "formuler-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/formuler-box/hot-iptv/" },
  openGraph: {
    title: "Hot Iptv IPTV Instruktioner | Monster TV",
    description: "Hot Iptv på Formuler Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/formuler-box/hot-iptv/",
    siteName: "Monster TV",
