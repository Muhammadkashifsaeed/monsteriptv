...
export const metadata: Metadata = {
  ...
  description: "Installera Smart Stb på Formuler Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["smart-stb", "IPTV", "formuler-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/formuler-box/smart-stb/" },
  openGraph: {
    title: "Smart Stb IPTV Instruktioner | Monster TV",
    description: "Smart Stb på Formuler Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/formuler-box/smart-stb/",
    siteName: "Monster TV",
