...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Smarters på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-smarters", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/iptv-smarters/" },
  openGraph: {
    title: "Iptv Smarters IPTV Instruktioner | Monster TV",
    description: "Iptv Smarters på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/iptv-smarters/",
    siteName: "Monster TV",
