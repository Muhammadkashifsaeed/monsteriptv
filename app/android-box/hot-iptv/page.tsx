...
export const metadata: Metadata = {
  ...
  description: "Installera Hot Iptv på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["hot-iptv", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/hot-iptv/" },
  openGraph: {
    title: "Hot Iptv IPTV Instruktioner | Monster TV",
    description: "Hot Iptv på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/hot-iptv/",
    siteName: "Monster TV",
