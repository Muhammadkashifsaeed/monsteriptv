...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Streamer på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-streamer", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/iptv-streamer/" },
  openGraph: {
    title: "Iptv Streamer IPTV Instruktioner | Monster TV",
    description: "Iptv Streamer på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/iptv-streamer/",
    siteName: "Monster TV",
