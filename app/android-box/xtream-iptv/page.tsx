...
export const metadata: Metadata = {
  ...
  description: "Installera Xtream Iptv på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["xtream-iptv", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/xtream-iptv/" },
  openGraph: {
    title: "Xtream Iptv IPTV Instruktioner | Monster TV",
    description: "Xtream Iptv på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/xtream-iptv/",
    siteName: "Monster TV",
