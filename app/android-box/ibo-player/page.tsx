...
export const metadata: Metadata = {
  ...
  description: "Installera Ibo Player på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["ibo-player", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/ibo-player/" },
  openGraph: {
    title: "Ibo Player IPTV Instruktioner | Monster TV",
    description: "Ibo Player på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/ibo-player/",
    siteName: "Monster TV",
