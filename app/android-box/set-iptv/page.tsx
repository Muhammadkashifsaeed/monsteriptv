...
export const metadata: Metadata = {
  ...
  description: "Installera Set Iptv på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["set-iptv", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/set-iptv/" },
  openGraph: {
    title: "Set Iptv IPTV Instruktioner | Monster TV",
    description: "Set Iptv på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/set-iptv/",
    siteName: "Monster TV",
