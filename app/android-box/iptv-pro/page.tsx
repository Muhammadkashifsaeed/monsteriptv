...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Pro på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-pro", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/iptv-pro/" },
  openGraph: {
    title: "Iptv Pro IPTV Instruktioner | Monster TV",
    description: "Iptv Pro på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/iptv-pro/",
    siteName: "Monster TV",
