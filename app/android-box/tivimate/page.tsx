...
export const metadata: Metadata = {
  ...
  description: "Installera Tivimate på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["tivimate", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/tivimate/" },
  openGraph: {
    title: "Tivimate IPTV Instruktioner | Monster TV",
    description: "Tivimate på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/tivimate/",
    siteName: "Monster TV",
