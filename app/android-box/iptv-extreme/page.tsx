...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Extreme på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-extreme", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/iptv-extreme/" },
  openGraph: {
    title: "Iptv Extreme IPTV Instruktioner | Monster TV",
    description: "Iptv Extreme på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/iptv-extreme/",
    siteName: "Monster TV",
