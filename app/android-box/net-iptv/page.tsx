...
export const metadata: Metadata = {
  ...
  description: "Installera Net Iptv på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["net-iptv", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/net-iptv/" },
  openGraph: {
    title: "Net Iptv IPTV Instruktioner | Monster TV",
    description: "Net Iptv på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/net-iptv/",
    siteName: "Monster TV",
