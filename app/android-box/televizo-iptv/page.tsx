...
export const metadata: Metadata = {
  ...
  description: "Installera Televizo Iptv på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["televizo-iptv", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/televizo-iptv/" },
  openGraph: {
    title: "Televizo Iptv IPTV Instruktioner | Monster TV",
    description: "Televizo Iptv på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/televizo-iptv/",
    siteName: "Monster TV",
