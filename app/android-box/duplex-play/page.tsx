...
export const metadata: Metadata = {
  ...
  description: "Installera Duplex Play på Android Box. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["duplex-play", "IPTV", "android-box", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/android-box/duplex-play/" },
  openGraph: {
    title: "Duplex Play IPTV Instruktioner | Monster TV",
    description: "Duplex Play på Android Box. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/android-box/duplex-play/",
    siteName: "Monster TV",
