...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Streamer på Datorn. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-streamer", "IPTV", "datorn", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/datorn/iptv-streamer/" },
  openGraph: {
    title: "Iptv Streamer IPTV Instruktioner | Monster TV",
    description: "Iptv Streamer på Datorn. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/datorn/iptv-streamer/",
    siteName: "Monster TV",
