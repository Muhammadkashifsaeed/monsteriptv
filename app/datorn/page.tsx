...
export const metadata: Metadata = {
  title: "IPTV på datorn 2026 | Monster TV - PC & Mac Guide",
  description: "Installera IPTV på din dator (Windows/macOS). Steg-för-steg guide för IPTV-appar på PC och Mac. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["IPTV", "datorn", "PC", "komputer", "Windows", "Mac", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/datorn/" },
  openGraph: {
    title: "IPTV på datorn 2026 | Monster TV - PC & Mac Guide",
    description: "Installera IPTV på din dator (Windows/macOS). 13,000+ kanaler tillgängliga.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/datorn/",
    siteName: "Monster TV",
    images: [{ url: "https://monstertv.tv/images/allsvenskan-2026.jpg", width: 1200, height: 630, alt: "Monster TV - IPTV på datorn" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "IPTV på datorn 2026 | Monster TV - PC & Mac Guide",
    description: "Installera IPTV på din dator (Windows/macOS).",
...
export default function DatornPage() {
  return (
    <div className="w-full font-sans bg-[#0a0a0a] min-h-screen">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center py-4">
            <a href="/installationsguider/windows-mac" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-12 rounded-full text-center transition-colors shadow-lg shadow-blue-500/30 text-lg w-full sm:w-auto">
              Windows
            </a>
            <a href="/installationsguider/windows-mac" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-12 rounded-full text-center transition-colors shadow-lg shadow-blue-500/30 text-lg w-full sm:w-auto">
              MAC
