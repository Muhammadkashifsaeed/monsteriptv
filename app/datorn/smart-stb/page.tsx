...
export const metadata: Metadata = {
  ...
  description: "Installera Smart Stb på Datorn. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["smart-stb", "IPTV", "datorn", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/datorn/smart-stb/" },
  openGraph: {
    title: "Smart Stb IPTV Instruktioner | Monster TV",
    description: "Smart Stb på Datorn. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/datorn/smart-stb/",
    siteName: "Monster TV",
