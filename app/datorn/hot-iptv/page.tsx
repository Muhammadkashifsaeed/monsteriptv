...
export const metadata: Metadata = {
  ...
  description: "Installera Hot Iptv pa Datorn. Steg-for-steg guide for IPTV. 13,000+ kanaler, filmer och live-sport tillgangliga.",
  keywords: ["Hot Iptv", "IPTV", "Monster TV", "installera", "guide", "Datorn"],
  alternates: { canonical: "https://monstertv.tv/datorn/hot-iptv/" },
  openGraph: {
    title: "Hot Iptv IPTV Instruktioner | Monster TV",
    description: "Installera Hot Iptv pa Datorn.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/datorn/hot-iptv/",
    siteName: "Monster TV",
