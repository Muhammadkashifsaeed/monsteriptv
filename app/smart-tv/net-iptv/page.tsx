...
export const metadata: Metadata = {
  ...
  description: "Installera Net Iptv på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["net-iptv", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/net-iptv/" },
  openGraph: {
    title: "Net Iptv IPTV Instruktioner | Monster TV",
    description: "Net Iptv på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/net-iptv/",
    siteName: "Monster TV",
