...
export const metadata: Metadata = {
  ...
  description: "Installera Duplex Play på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["duplex-play", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/duplex-play/" },
  openGraph: {
    title: "Duplex Play IPTV Instruktioner | Monster TV",
    description: "Duplex Play på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/duplex-play/",
    siteName: "Monster TV",
