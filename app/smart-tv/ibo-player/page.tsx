...
export const metadata: Metadata = {
  ...
  description: "Installera Ibo Player på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["ibo-player", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/ibo-player/" },
  openGraph: {
    title: "Ibo Player IPTV Instruktioner | Monster TV",
    description: "Ibo Player på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/ibo-player/",
    siteName: "Monster TV",
