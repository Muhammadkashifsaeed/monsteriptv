...
export const metadata: Metadata = {
  ...
  description: "Installera Tivimate på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["tivimate", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/tivimate/" },
  openGraph: {
    title: "Tivimate IPTV Instruktioner | Monster TV",
    description: "Tivimate på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/tivimate/",
    siteName: "Monster TV",
