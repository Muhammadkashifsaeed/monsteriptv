...
export const metadata: Metadata = {
  ...
  description: "Installera Xtream Iptv på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["xtream-iptv", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/xtream-iptv/" },
  openGraph: {
    title: "Xtream Iptv IPTV Instruktioner | Monster TV",
    description: "Xtream Iptv på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/xtream-iptv/",
    siteName: "Monster TV",
