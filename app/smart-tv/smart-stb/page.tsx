...
export const metadata: Metadata = {
  ...
  description: "Installera Smart Stb på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["smart-stb", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/smart-stb/" },
  openGraph: {
    title: "Smart Stb IPTV Instruktioner | Monster TV",
    description: "Smart Stb på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/smart-stb/",
    siteName: "Monster TV",
