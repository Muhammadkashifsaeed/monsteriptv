...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Smarters på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-smarters", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/iptv-smarters/" },
  openGraph: {
    title: "Iptv Smarters IPTV Instruktioner | Monster TV",
    description: "Iptv Smarters på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/iptv-smarters/",
    siteName: "Monster TV",
