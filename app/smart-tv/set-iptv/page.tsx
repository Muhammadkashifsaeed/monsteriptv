...
export const metadata: Metadata = {
  ...
  description: "Installera Set Iptv på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["set-iptv", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/set-iptv/" },
  openGraph: {
    title: "Set Iptv IPTV Instruktioner | Monster TV",
    description: "Set Iptv på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/set-iptv/",
    siteName: "Monster TV",
