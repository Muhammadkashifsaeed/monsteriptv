...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Pro på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-pro", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/iptv-pro/" },
  openGraph: {
    title: "Iptv Pro IPTV Instruktioner | Monster TV",
    description: "Iptv Pro på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/iptv-pro/",
    siteName: "Monster TV",
