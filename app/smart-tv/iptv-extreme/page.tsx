...
export const metadata: Metadata = {
  ...
  description: "Installera Iptv Extreme på Smart Tv. Steg-för-steg guide för IPTV. 13,000+ kanaler, filmer och live-sport tillgängliga.",
  keywords: ["iptv-extreme", "IPTV", "smart-tv", "Monster TV", "guide"],
  alternates: { canonical: "https://monstertv.tv/smart-tv/iptv-extreme/" },
  openGraph: {
    title: "Iptv Extreme IPTV Instruktioner | Monster TV",
    description: "Iptv Extreme på Smart Tv. 13,000+ kanaler, filmer och live-sport.",
    type: "website",
    locale: "sv_SE",
    url: "https://monstertv.tv/smart-tv/iptv-extreme/",
    siteName: "Monster TV",
